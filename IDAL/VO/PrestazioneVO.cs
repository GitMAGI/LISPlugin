...
namespace IDAL.VO
{
    public class PrestazioneVO
    {
        ...
        public string presappu { get; set; }
        ...
        public int? presrefe { get; set; }
        public int? presimgstat { get; set; }
        public byte[] presimg { get; set; }
        public DateTime? presacqu { get; set; }
    }
}